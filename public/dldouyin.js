...
// Remove any ReadableStream-related code
...
async function downloadv1(url) {
    try {
        ...
        console.error("Error in downloadv1:", error.message);
        throw error;
    }
}
...
async function index(req, res, next) {
    try {
        ...
        console.error("Error in index route:", error.message);
        res.status(500).json({ error: 'Internal server error' });
    }
}

module.exports = {
    name: '/tiktok/downloadv2',
    downloadv1,
    index
};